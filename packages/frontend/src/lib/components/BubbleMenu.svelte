...
>
    {#if !isEditingLink}
        ...
        <button
            ...
            title="Ctrl + E"
        >
            <i class="text-[20px] flex justify-center items-center ph ph-code"
            ></i>
        </button>
        ...
        >
            <i
                class="text-[20px] flex justify-center items-center ph ph-text-h-one"
            ></i>
        </button>
        <button
            onclick={() =>
        ...
        >
            <i
                class="text-[20px] flex justify-center items-center ph ph-text-h-two"
            ></i>
        </button>
        <button
            onclick={() =>
        ...
        >
            <i
                class="text-[20px] flex justify-center items-center ph ph-code-block"
            ></i>
        </button>
        <div class="h-4 w-[1px] my-auto mx-1 bg-on-primary opacity-50"></div>
        <button
        ...
        >
            <i
                class="text-[20px] flex justify-center items-center ph ph-link-simple"
            ></i>
        </button>
    {:else}
        <div class="flex gap-1 w-min">
            ...
            >
                <i
                    class="text-[20px] flex justify-center items-center ph ph-check"
                ></i>
            </button>
            <button
                onclick={() => {
                ...
                aria-label="Назад"
            >
                <i class="text-[20px] flex justify-center items-center ph ph-x"
                ></i>
            </button>
        </div>
    {/if}
